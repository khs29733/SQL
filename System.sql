...
별칭 “이름”, “월급”, “전화번호”, “입사일” 로 컬럼이름을 대체해 보세요
*/
...
/*문제5.14000 미만 10000 이상인 ( < 14000 AND >=10000) -> BETWEEN불가
...
/*
문제7.
이름(first_name)에 S('%S') 또는 s 가 들어가는 직원의 이름, 월급을 나타내시오
*/
